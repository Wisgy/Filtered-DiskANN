...
template <typename T, typename TagT, typename LabelT>
std::pair<uint32_t, uint32_t> Index<T, TagT, LabelT>::iterate_to_fixed_point_filtered(
                                                                           ...
                                                                           std::any &indices, float *distances)
{
    ...
    {
        this->_filter_trees[raw_logic_expr] = new SyntaxTree<LabelT>(
            this->_use_universal_label ? this->_universal_label : 0, this->_label_map, raw_logic_expr);
    }
    ...
    if (typeid(uint64_t *) == indices.type())
    {
        ...
        return this->search_with_filters(std::any_cast<T *>(query), raw_logic_expr, converted_label, K, L, ptr,
                                         distances);
    }
...
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<float, uint64_t, uint32_t>::search_with_filters<
    uint64_t>(const float *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<float, uint64_t, uint32_t>::search_with_filters<
    uint32_t>(const float *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
...
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<uint8_t, uint64_t, uint32_t>::search_with_filters<
    uint64_t>(const uint8_t *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<uint8_t, uint64_t, uint32_t>::search_with_filters<
    uint32_t>(const uint8_t *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
              const size_t K, const uint32_t L, uint32_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<int8_t, uint64_t, uint32_t>::search_with_filters<
    uint64_t>(const int8_t *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<int8_t, uint64_t, uint32_t>::search_with_filters<
    uint32_t>(const int8_t *query, const std::string &raw_logic_expr, std::vector<uint32_t> &filter_labels,
              const size_t K, const uint32_t L, uint32_t *indices, float *distances);
// TagT==uint32_t
...
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<float, uint64_t, uint16_t>::search_with_filters<
    uint64_t>(const float *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<float, uint64_t, uint16_t>::search_with_filters<
    uint32_t>(const float *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint32_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<uint8_t, uint64_t, uint16_t>::search_with_filters<
    uint64_t>(const uint8_t *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<uint8_t, uint64_t, uint16_t>::search_with_filters<
    uint32_t>(const uint8_t *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint32_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<int8_t, uint64_t, uint16_t>::search_with_filters<
    uint64_t>(const int8_t *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint64_t *indices, float *distances);
template DISKANN_DLLEXPORT std::pair<uint32_t, uint32_t> Index<int8_t, uint64_t, uint16_t>::search_with_filters<
    uint32_t>(const int8_t *query, const std::string &raw_logic_expr, std::vector<uint16_t> &filter_labels,
              const size_t K, const uint32_t L, uint32_t *indices, float *distances);
// TagT==uint32_t
